...
import style from '../css/Salesign.css';

const Salesign = ({className}) => {
    return (
        <svg className="saleSign" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60.53 60.53">
            ...
            <g id="Layer_2" data-name="Layer 2">
                <g id="Layer_1-2" data-name="Layer 1">
                    ...
                    <text className="cls2" transform="translate(18.09 26.87)">40%<tspan x="0" y="13.65">OFF</tspan></text></g>
            </g>
        </svg>
    )
}
